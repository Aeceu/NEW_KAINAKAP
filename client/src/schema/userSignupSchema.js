...
export const stepOneSchema = z
  .object({
    ...
    civil: z.enum(
      ["Single", "Married", "Legally Separated", "Widowed", "Solo Parent"],
      {
        message: "Required",
      },
    ),
...
export const stepFiveSchema = z
  .object({
    employment: z.enum(["Student", "Employed", "Unemployed"], {
      message: "Required",
    }),
...
export const stepSixSchema = z.object({
  blood: z.enum(["A+", "B+", "O+", "AB+", "A-", "B-", "O-", "AB-"], {
    message: "Required",
  }),
  ...
  made_disabled: z.enum(["Inborn", "Sickness", "Accident"], {
    message: "Required",
  }),
